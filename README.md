<div align="center"> <!-- Animated Header Banner --> <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Mitul%20Nayakwadi&fontSize=50&fontColor=ffffff&fontAlignY=38&desc=Technologist%20%7C%20Builder%20%7C%20Innovator&descAlignY=58&descSize=18&animation=fadeIn" width="100%"/>
...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=C+%26+Python+Developer+%F0%9F%90%8D;AI+%2B+Practical+Solutions;Web+Development+Enthusiast;Data+Structures+%26+Algorithms" alt="Typing SVG"/>
</a>
...
<p>
  ...
  &nbsp;
  <a href="mailto:mitulnayakwadi@gmail.com">
...
class Mitul:
    def __init__(self):
        self.name        = "Mitul Nayakwadi"
        self.role        = "Technologist & Developer"
        self.location    = "India 🇮🇳"
        self.languages   = ["C", "Python", "JavaScript", "HTML/CSS"]
        self.interests   = ["AI/ML", "Web Dev", "Systems Programming", "DSA"]
        self.daily_grind = "~2 hours of deep work & learning ⏱️"
        self.philosophy  = "Respect tradition. Question everything. Build for the future."

    def current_focus(self):
        return [
            "🔍 Sharpening C & Python fundamentals",
            "🚀 Blending AI with practical applications",
            "🛠️  Crafting meaningful web experiences",
            "🧩 Mastering Data Structures & Algorithms"
        ]

    def values(self):
        return ["Craftsmanship", "Clean Code", "Curiosity", "Skepticism"]
...
## <img src="https://media.giphy.com/media/LmNwrBhejkK9EFP504/giphy.gif" width="28"/> &nbsp; Currently Working On

<table>
  <tr>
    <td>🔍</td>
    <td><strong>C & Python Fundamentals</strong> — Going deep into memory management, pointers, and Pythonic patterns</td>
  </tr>
  <tr>
    <td>🚀</td>
    <td><strong>AI-Powered Projects</strong> — Building practical tools that blend ML with real-world problems</td>
  </tr>
  <tr>
    <td>🛠️</td>
    <td><strong>Web Development</strong> — Experimenting with frontend & backend to create meaningful digital experiences</td>
  </tr>
  <tr>
    <td>🧩</td>
    <td><strong>DSA Practice</strong> — Daily problem-solving to sharpen algorithmic thinking</td>
  </tr>
</table>
...
<!-- Quote Section -->
## <img src="https://media.giphy.com/media/7c8QeB0VMddFOuu4iR/giphy.gif" width="28"/> &nbsp; Dev Philosophy
...
<img src="https://media.giphy.com/media/jpVnC65DmYeyRL4LHS/giphy.gif" width="60" alt="Star"/>

*If you find my work interesting, drop a ⭐ — it means a lot!*
